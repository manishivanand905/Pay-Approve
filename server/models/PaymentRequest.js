...
const activitySchema = new mongoose.Schema(
  {
    ...
    role: { type: String, required: true, enum: ['admin', 'requester', 'finance_manager', 'finance_head', 'banker'] },
    action: { type: String, required: true, enum: ['created', 'approved', 'rejected', 'on_hold', 'paid', 'updated', 'commented'] },
...
const paymentRequestSchema = new mongoose.Schema(
  {
    ...
    materialItem: { type: String, trim: true, default: '' },
    amount: { type: Number, required: true, min: 0 },
    currency: { type: String, default: 'INR', trim: true, uppercase: true },
    dueDate: { type: Date },
    requestedPaymentMode: { type: String, trim: true, default: '' },
    requestChannel: { type: String, trim: true, default: 'Manual' },
    ...
    status: {
      ...
      required: true,
      default: 'pending',
      enum: ['pending', 'manager_approved', 'head_approved', 'on_hold', 'rejected', 'paid'],
    },
    paymentDetails: {
