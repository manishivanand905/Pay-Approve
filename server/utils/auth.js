...
const canManageRole = (actorRole, targetRole) => getCreatableRoles(actorRole).includes(targetRole);
const generateToken = (userId) =>
  jwt.sign({ userId }, process.env.JWT_SECRET, {
    expiresIn: process.env.JWT_EXPIRES_IN || '7d',
  });

module.exports = { ROLE_CREATION_SCOPE, getCreatableRoles, canManageRole, generateToken };
